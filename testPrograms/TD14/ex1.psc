...
*/
procédure permuter(entF/sortF p1 : t_personne, entF/sortF p2 : t_personne) c'est
début
    tmp : t_personne;
    tmp := p1;
    p1 := p2;
...
*/
procédure triNaif(entF/sortF t : t_tabPersonnes, entF nbPers : entier) c'est
    iMin : entier;
    ...
    pour (i de 1 à nbPers) faire
        ...
        pour (iRecMin de i + 1 à nbPers) faire
            si (t[iRecMin].c_nom < t[iMin]) alors
                iMin := iRecMin;
            finsi
        finfaire
...
*/
procédure afficherTableau(entF t : t_tabPersonnes, entF nbPers : entier) c'est
    pour (i de 1 à nbPers) faire
...
début
    ...
    constante banque : t_tabPersonnes := {
        {"toto", {21,25,12}, 3},
        {"dupont", {56}, 1},
        {"albert", {19,123,111}, 3},
        {"alfred", {20,312}, 2}
