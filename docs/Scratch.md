...
**Let files be state machines**. Keep track of its state. Function calls represent transitions.
...
And what happens if we return a file or pass it to a function/procedure
